pandoc -V geometry:a4paper -V 'mainfont:Palatino' -V 'sansfont:Helvetica' -V geometry:margin=2cm --pdf-engine=xelatex questioni_di_esame.md -o questioni_di_esame.pdf 
